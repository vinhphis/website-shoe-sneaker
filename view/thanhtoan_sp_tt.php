...
<?php endif ?>
<div class="checkout">
    <form action="?act=dathang_sp_tt" method="post" class="chiaform_checkout">
        <!-- <div class="row3"> -->
        <div class="checkout-left">
            ...
            <div class="section-title-input-thanhtoan">
                ...
                <div class="input-radio checkpayments">
                    <input type="radio" name="payment" id="" style="margin-right: 10px; " onclick="qrcode()" value="Thanh toán qua tài khoản ngân hàng">
                    <span>Thanh toán bằng tài khoản ngân hàng
                    </span>
                </div>
                <div class="input-radio checkpayments">
        ...
        <div class="checkout-right">
            <div class="scroll_table_check">
                <table class="check_right_product">
                    <?php
                    $sum_hd = $tong_hd = 0;
                    if (isset($thanhtoan_sp_tt)) {
                        extract($thanhtoan_sp_tt);
                    
                        $imagepath = "../upload/" . $image;
                        $sum_price = $thanhtoan_sp_tt['0'] * $price_sale;
                        $sum_hd += $sum_price;
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="detail_checkout">
                                ...
                                <p>Số lượng: <?= $thanhtoan_sp_tt['0'] ?></p>
                                <input type="hidden" name="soluong" value="<?= $thanhtoan_sp_tt['0'] ?>">
                            </td>
                            <td>
            ...
            <div class="giamgia-right">
                <form action="?act=thanhtoan_sp_tt" method="post">
                    ...
                    <input class="apdung" type="submit" name="apdung_sp_tt" value="Áp dụng">
                </form>
